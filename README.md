...
- Idempotent Omarchy local setup script that installs preferred packages/apps including Oh My Pi, sets Tokyo Night/Ghostty/Zen/Zed defaults, patches app bindings, and removes redundant preinstalls while keeping Chromium for Omarchy web apps
